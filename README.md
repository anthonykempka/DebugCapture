...
1. [DebugCaptureCode](https://github.com/anthonykempka/DebugCapture/tree/main/DebugCaptureCode) is an MFC based dialog application for capture debug output from a running process
